 ...
 * useJobFilters.js
 *
 * Encapsulates all local filter, search, sort, and pagination logic for a jobs collection.
...
/**
 * logger for useJobFilters hook.
 *
 * @constant
 * @type {{info: Function, error: Function}}
 */
const logger = {
    info: (...args) => console.log("[useJobFilters]", ...args),
    error: (...args) => console.error("[useJobFilters]", ...args),
};
...
export const useJobFilters = (
    ...
    logger.info("useJobFilters initialized", {
        initialSortKey,
        initialPageSize,
    });
    ...
    const handleResetFilters = () => {
        logger.info("useJobFilters handleResetFilters");
        setSearchInput("");
        setSearch("");
